...
g = Game()
platform1 = NonMovingSprite(g, PhotoImage(file='platform1.gif'), 0, 480, 100, 10)
platform2 = NonMovingSprite(g, PhotoImage(file='platform1.gif'), 150, 440, 100, 10)
platform3 = NonMovingSprite(g, PhotoImage(file='platform1.gif'), 300, 400, 100, 10)
platform4 = NonMovingSprite(g, PhotoImage(file='platform1.gif'), 300, 160, 100, 10)
platform5 = MovingPlatformSprite(g, PhotoImage(file='platform2.gif'), 175, 350, 66, 10)
platform6 = NonMovingSprite(g, PhotoImage(file='platform2.gif'), 50, 300, 66, 10)
platform7 = NonMovingSprite(g, PhotoImage(file='platform2.gif'), 170, 120, 66, 10)
platform8 = NonMovingSprite(g, PhotoImage(file='platform2.gif'), 45, 60, 66, 10)
platform9 = MovingPlatformSprite(g, PhotoImage(file='platform3.gif'), 170, 250, 32, 10)
platform10 = NonMovingSprite(g, PhotoImage(file='platform3.gif'), 230, 200, 32, 10)
